      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildSection(
              'القبول بالشروط',
              'باستخدامك لتطبيق عقار اونلاين، فإنك توافق على هذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، يجب عليك التوقف عن استخدام التطبيق فوراً.',
            ),
            _buildSection(
              'وصف الخدمة',
              'عقار اونلاين هو تطبيق عقاري يهدف إلى تسهيل عملية البحث عن العقارات وعرضها للبيع أو الإيجار داخل سوريا. يوفر التطبيق منصة للتواصل بين مالكي العقارات والباحثين عنها.',
            ),
            _buildSection(
              'حساب المستخدم',
